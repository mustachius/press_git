...
include_graphics("https://raw.githubusercontent.com/mustachius/press_git/master/tabela%20reg_1.png")
```
???
...
class: middle, center
```{r fig.align='center', echo=FALSE}
include_graphics("https://raw.githubusercontent.com/mustachius/press_git/master/tabela%20reg_2.png")
```
---
class: middle, center, inverse
