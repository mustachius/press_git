...
???
EPM muito sensível à valores <1, influencia no resultado.
---
class: middle, center
```{r fig.align='center', echo=FALSE}
include_graphics("https://raw.githubusercontent.com/mustachius/press_git/gh-pages/tabreg1.png")
```
???
ROOT MEAN SQUARE ERROR - RAIZ DO ERRO MÉDIO QUADRÁTICO
  raiz do erro médio quadrático da diferença entre a predição e o valor re
...
class: middle, center
```{r fig.align='center', echo=FALSE}
include_graphics("https://raw.githubusercontent.com/mustachius/press_git/gh-pages/tabreg2.png")
```
---
class: middle, center, inverse
...
```
???
td -> tempo duplicação celular
ypx -> taxa de produão de enterotoxina por bactéria
...
--
- Produção de enterotoxinas → processo sujeito a interferências diversas.
--
...
<center><h4> A possibilidade de reproduzir os resultados com modelos que envolvam a simulação do comportamento e produção de enterotoxinas pode ser alternativa promissora</h4></center>
---
class: middle, center, inverse
